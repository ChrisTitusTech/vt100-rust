...
pub fn compare_screens(
    got: &vt100_ctt::Screen,
    expected: &vt100_ctt::Screen,
) -> bool {
    ...
    is!(
        Bytes(&got.contents_diff(vt100_ctt::Parser::default().screen())),
        Bytes(&expected.contents_diff(vt100_ctt::Parser::default().screen()))
    );
...
pub fn contents_formatted_reproduces_screen(screen: &vt100_ctt::Screen) -> bool {
    ...
    let mut new_parser = vt100_ctt::Parser::default();
...
pub fn rows_formatted_reproduces_screen(screen: &vt100_ctt::Screen) -> bool {
